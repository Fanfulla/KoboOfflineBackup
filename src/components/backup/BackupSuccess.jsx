        ...
        <div className="p-4 bg-kobo-success/10 border border-kobo-success/20 rounded-lg mb-8">
          <div className="flex items-start gap-3">
            ...
            <div className="text-left flex-1">
              <p className="font-semibold text-kobo-dark mb-1">
        ...
        <div className="text-left mb-8 p-6 bg-kobo-cream-dark rounded-lg">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-kobo-dark">Upload to cloud storage</p>
                <p className="text-sm text-kobo-gray">Google Drive, Dropbox, or OneDrive</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-kobo-accent">💾</span>
              <div>
                <p className="font-medium text-kobo-dark">Copy to external drive</p>
                <p className="text-sm text-kobo-gray">Keep a physical backup for safety</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-kobo-accent">🔒</span>
              <div>
                <p className="font-medium text-kobo-dark">Store in multiple locations</p>
                <p className="text-sm text-kobo-gray">3-2-1 backup rule: 3 copies, 2 different media, 1 offsite</p>
              </div>
            </li>
          </ul>
        </div>
...
function SummaryCard({ icon, label, value, truncate }) {
  return (
    <div className="p-4 bg-white rounded-lg border-2 border-kobo-cream-dark">
      ...
      <p className="text-xs text-kobo-gray mb-1">{label}</p>
      <p className={`text-sm font-semibold text-kobo-dark ${truncate ? 'truncate' : ''}`}>
        {value}
      </p>
    </div>
  );
